...
fun logVideoQuartile(player: VideoPlayer?) {
    player?.apply {//apply es una lambda, esta parte es la parte de arriba donde dice player == null, por eso el ?
...
fun main(args: Array<String>) {
    val video = VideoPlayer(75)
    val video2 = logVideoQuartile(video)
    print(video2)
}